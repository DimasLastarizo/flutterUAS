-- ═══════════════════════════════════════════════════════════════════════════
-- submit_level_result: skor 0 tidak boleh menyelesaikan level (backend-safe)
-- ═══════════════════════════════════════════════════════════════════════════
...
BEGIN
  ...
  -- Skor 0: tidak ubah progress, XP, unlock, atau leaderboard.
  IF p_correct_count = 0 THEN
    -- Perbaiki data korup dari versi lama (selesai dengan skor 0).
...
-- Perbaiki baris yang sudah terkorup sebelum migrasi ini.
UPDATE user_level_progress SET
  status = 'aktif',
  updated_at = now()
